...
public class Pago extends JFrame {
	...
	//	private JLabel lblTeFalataPor;
	private JLabel lblHaIntroducido;
//	private JLabel lblrestantePorIntroducir;
	//private JLabel lbldineroSobrante;


	
	public Pago(double precioFinal) {
		...
		textArea.setBounds(31, 77, 450, 88);
		contentPane.add(textArea);
		textArea.setLineWrap(true); 

		
		
		// Pregunta + input de entrada
		JLabel lblconCuantoDesea = new JLabel("Intruduzca El Dinero");
		lblconCuantoDesea.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblconCuantoDesea.setBounds(31, 32, 238, 34);
		contentPane.add(lblconCuantoDesea);
		
		cantidadpago = new JTextField();
		
		
		cantidadpago.setBounds(395, 41, 86, 20);
		contentPane.add(cantidadpago);
		cantidadpago.setColumns(10);
		
		JButton btnContinuar = new JButton("Pagar");
		...
		btnContinuar.setBounds(31, 181, 89, 23);
		contentPane.add(btnContinuar);
		
		JButton btnImprimir = new JButton("Imprimir");
		btnImprimir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//para imprimir en txt
				try {
		...
		btnImprimir.setBounds(213, 181, 89, 23);
		...
		button.setBounds(392, 176, 89, 23);
